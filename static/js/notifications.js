 ...
 *
 * It is written as an IIFE to avoid polluting the global scope, but attaches its
 * functions to the `window` object to make them globally accessible.
 */
...
(function(window) {
    ...
    // Expose the functions to the global scope to be used by other scripts.
